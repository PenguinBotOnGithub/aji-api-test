...
List<ProductMoment> productMomentFromJson(String str) =>
    List<ProductMoment>.from(
        json.decode(str).map((x) => ProductMoment.fromJson(x)));

String productMomentToJson(List<ProductMoment> data) =>
...
class ProductMoment {
  ...
  factory ProductMoment.fromJson(Map<String, dynamic> json) => ProductMoment(
        id: json["id"],
